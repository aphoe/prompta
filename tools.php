<?php
$title = "Tools Prompt Generator - Prompta";
$description = "Generate intelligent prompts for software tools, APIs, and development resources. Free AI prompt generator for tool analysis.";
$keywords = "AI prompts, tools generator, software tools, APIs, development resources, prompt generator";
$jsonld_name = "Tools Prompt Generator";
$jsonld_desc = "Generate intelligent prompts for software tools, APIs, and development resources.";
?>
<!DOCTYPE html>
<html lang="en">
