<?php
$title = "Bookmark Prompt Generator";
$description = "Generate intelligent prompts for saved bookmarks and interesting links. Free AI prompt generator for bookmark analysis.";
$keywords = "AI prompts, bookmark generator, saved bookmarks, interesting links, prompt generator";
$jsonld_name = "Bookmark Prompt Generator";
$jsonld_desc = "Generate intelligent prompts for saved bookmarks and interesting links.";
?>
<!DOCTYPE html>
<html lang="en">
